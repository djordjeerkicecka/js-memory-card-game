...
const modalRegistration = document.getElementById('modal--register');

// Modal Controls
const modalBtnConfirm = document.getElementById('modal--btn-yes');
const modalBtnDecline = document.getElementById('modal--btn-no');
